<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reviewer.aspx.cs" Inherits="IEgypt.Reviewer" %>
...
">
   <form id="f1" runat="server">
    ...
    <asp:Table ID="Table1" BackColor="YellowGreen" BorderColor="Black" GridLines="Both"  BorderStyle="Solid" runat="server"/>
        ...
        <asp:Button id="B11" runat="server" OnClick="RedirectToDefaule" Text="Return"/>
	</form>
</body>
</html>